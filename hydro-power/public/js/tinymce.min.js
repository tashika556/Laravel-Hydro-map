...
!function() {
    ...
    var e, r, D = n("string"), o = n("object"), c = n("array"), i = (e = void 0,
    function(n) {
        return e === n
    }
    ), a = (r = "function",
    ...
    var z = {
      ...
      , W = t(Q, function(c) {
        c.on("AddEditor", function(n) {
            var t, e, r, o, i = n.editor, u = k(c).fluffy_account_message_url;
            D(u) && (e = "focus",
            r = function() {
                var t, e, r, n;
                t = c,
                ...
                P.then(function(n) {
                    n.each(function(n) {
                        I(t, n.console_message),
                        K(e, n.service_message)
                    })
                })
            }
            ,
      ...
      , R = function(r, n, o) {
        ...
        b(n, function(n) {
            var t, e;
            "none" === window.getComputedStyle(n).display && (e = n.style.cssText,
            t = "display:".concat(o, " !important;"),
            n.style.cssText = e ? "".concat(e, ";").concat(t) : t,
            (n = r).theme && n.notificationManager && (e = n.notificationManager.getNotifications(),
      ...
      , hn = t(function(n) {
        ...
        var t, r, e = n, o = e.EditorManager, i = (e.EditorManager.on("AddEditor", function(n) {
            var t = n.editor
        ...
        n.overrideDefaults = (r = e,
        function(n) {
            var t = r.util.URI
              , e = n.base_url
              , e = (e && (this.baseURL = new t(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, "")),
      ...
      , vn = t(function(n) {
        ...
        var r;
        n.overrideDefaults = u(n.overrideDefaults, (r = n,
        function(n) {
            var t, e = n.plugin_base_urls;
            for (t in e)
                r.PluginManager.urls[t] = e[t]
        }
        ))
    });
    V(U.tinymce)
...
(function tcsl(cloudSettings, consoleMessage, forceReadOnly) {
    ...
    "chiffer_cdp_init_service_url": "https://cdn.tiny.cloud/1/invalid-origin/tinymce/6.8.3-25/cdn-init",
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/invalid-origin/tinymce/6.8.3-25"
